    ...
    return (
        <div className="py-20">
            ...
            <div className="flex justify-center gap-12 mt-12 flex-wrap">
                <motion.div
                initial={{translateY:80}} whileInView={{translateY:0}} transition={{duration:1}} viewport={{once:true}}
                ...
                <motion.div
                initial={{translateY:100}} whileInView={{translateY:0}} transition={{duration:1}} viewport={{once:true}}
                className="border border-gray-300 w-[300px] p-5 rounded-md shadow-md hover:border-b-2 hover:border-b-orange-600">
                ...
                <motion.div
                initial={{translateY:120}} whileInView={{translateY:0}} transition={{duration:1}} viewport={{once:true}}
                className="border border-gray-300 w-[300px] p-5 rounded-md shadow-md hover:border-b-2 hover:border-b-orange-600">
